...
maternal<-read.csv("../Data/kichler_maternal.csv")
maternal
offspring<-read.csv("../Data/kichler_offspring.csv")
offspring
...
sire_genotypes[,c(2:3)]=sample(af[[1]][,1],length(sires),prob=af[[1]][,2],replace = T)
sire_genotypes[,c(4:5)]=sample(af[[2]][,1],length(sires),prob=af[[2]][,2],replace = T)
sire_genotypes[,c(6:7)]=sample(af[[3]][,1],length(sires),prob=af[[3]][,2],replace = T)
sire_genotypes
?sample
...
sample(af[[1]][,1],82,prob=af[[1]][,2],replace=T)
